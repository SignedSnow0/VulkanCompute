...
Image::Image(const std::shared_ptr<VulkanManager>& vulkanManager, VkExtent2D extent)
...
void Image::ChangeLayout(VkImageLayout newLayout)
{
	    mVulkanManager->SubmitCommnand([&](VkCommandBuffer commandBuffer) {
            ...
            if (mLayout == VK_IMAGE_LAYOUT_UNDEFINED && newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
            ...
            else if (mLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL && newLayout == VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL) {
